                ...
                <div class="col">
                    ...
                    <div class="row align-items-center pt-4 appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" style="animation-delay: 100ms;">
                        <div class="col-md-4 mb-4 mb-md-0">
                            <img class="img-fluid scale-6 pr-5 pr-md-0 my-4" src="https://minepos.b-cdn.net/img/Browser%20Mockup.png" alt="Sleek Layout">
                        </div>
                    ...
                    <div class="row align-items-center pt-5 pb-3 appear-animation animated fadeInRightShorter appear-animation-visible" data-appear-animation="fadeInRightShorter" style="animation-delay: 100ms;">
                        ...
                        <div class="col-md-4 px-5 px-md-3">
                            <img class="img-fluid scale-6 my-4" src="https://minepos.b-cdn.net/img/Browser%20Mockup(1).png" alt="Order Management">
                        </div>
                    </div>
                    <hr class="solid my-5">
                    <div class="row align-items-center pt-4 appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" style="animation-delay: 100ms;">
                        <div class="col-md-4 mb-4 mb-md-0">
                            <img class="img-fluid scale-6 pr-5 pr-md-0 my-4" src="https://minepos.b-cdn.net/img/Browser%20Mockup(2).png" alt="User Management">
                        </div>
                        <div class="col-md-8 pl-md-5">
