			...
			<section>
				<div>
					...
					<ul>
						...
						<li>Theme Changes for Default Theme (Custom Logos, Custom Colors)</li>
						<li>Minecraft Plugin Intergration [Spigot & Bungee]</li>
					</ul>
					<br>
					<br>
					<p>If anyone has any questions about the Future of MinePOS, Please reach out to us in our <a href="https://discord.gg/Uk25cXM">Discord</a>!</p>
				</div>
			</section>
